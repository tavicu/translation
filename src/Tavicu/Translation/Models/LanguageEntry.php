...
class LanguageEntry extends WaaviModel {
	...
	{
		return $this->belongsTo('Tavicu\Translation\Models\Language');
	}

	/**
	 *  Return the language entry in the default language that corresponds to this entry.
	 *  @param Tavicu\Translation\Models\Language  $defaultLanguage
	 ...
	 *
	 *  @param Tavicu\Translation\Models\Language
	 *  @return Tavicu\Translation\Models\LanguageEntry
	 */
