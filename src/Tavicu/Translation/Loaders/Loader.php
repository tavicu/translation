...
class Loader implements LoaderInterface {
	 ...
	 *
	 * @var \Tavicu\Translation\Providers\LanguageProvider
	 */
	 ...
	 *
	 * @var \Tavicu\Translation\Providers\LanguageEntryProvider
	 */
	...
	protected function setApp($app)
	{
		...
		$this->cacheTimeout  = $app['config']['tavicu/translation::cache.timeout'];
		$this->cacheEnabled  = $app['config']['tavicu/translation::cache.enabled'] == 'on'
									|| ($app['config']['tavicu/translation::cache.enabled'] == 'auto' && !$app['config']['app.debug']);
	}

	/**
	 *	Sets the language and language entry providers.
	 * 	@param  \Tavicu\Translation\Providers\LanguageProvider  		$languageProvider
	 * 	@param 	\Tavicu\Translation\Providers\LanguageEntryProvider		$languageEntryProvider
	 * 	@return void
	 */
	...
	{
		$namespace = $namespace ?: '*';
		$cacheKey  = "tavicu|translation|$locale.$group.$namespace";
	...
	public function loadRaw($locale, $group, $namespace = null)
	{
		...
		{
			return $this->loadRawLocale($locale, $group, $namespace);
		}
		else
		{
