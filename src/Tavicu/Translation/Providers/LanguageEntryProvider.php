<?php namespace Tavicu\Translation\Providers;
...
class LanguageEntryProvider {
	 ...
	 *	@var string
	 */
	protected $model = 'Tavicu\Translation\Models\LanguageEntry';
	 ...
	 *	@param Tavicu\Translation\Models\Language 				$reference
	 *	@param Tavicu\Translation\Models\Language 				$target
	 *	@return Tavicu\Translation\Models\LanguageEntry
	 */
